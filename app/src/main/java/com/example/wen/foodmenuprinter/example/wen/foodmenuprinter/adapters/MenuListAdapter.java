...
public class MenuListAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(convertView==null) {
            ...
            Button deleteMenuItem = (Button) convertView.findViewById(R.id.menu_item_delete_button);
            deleteMenuItem.setOnClickListener(new MenuOnClickListener(convertView.getContext(), parent, position, menuObjectsList));
        }
